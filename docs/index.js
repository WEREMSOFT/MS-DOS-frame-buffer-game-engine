...
Module['FS_createPath']("/assets", "shaders", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/shaders/default.fs", "start": 0, "end": 165}, {"filename": "/assets/shaders/default.vs", "start": 165, "end": 385}, {"filename": "/assets/shaders/defaultWeb.fs", "start": 385, "end": 574}, {"filename": "/assets/shaders/defaultWeb.vs", "start": 574, "end": 792}, {"filename": "/assets/test.c", "start": 792, "end": 18262}, {"filename": "/assets/topScoreSquare.bmp", "start": 18262, "end": 56716}], "remote_package_size": 56716});

  })();

// end include: /tmp/tmpbnqkwcmq.js
// include: /tmp/tmpo1lyd0da.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpo1lyd0da.js
// include: /tmp/tmpezn4v0ml.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpezn4v0ml.js
